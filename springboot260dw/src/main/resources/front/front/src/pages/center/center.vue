    ...
    <el-tabs tab-position="left" :style='{"width":"100%","flexWrap":"wrap","justifyContent":"center","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label="住址" prop="zhuzhi">
            <el-input v-model="sessionForm.zhuzhi" placeholder="住址" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label="手机号" prop="mobile">
            <el-input v-model="sessionForm.mobile" placeholder="手机号" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label="密保问题" prop="pquestion">
            <el-input v-model="sessionForm.pquestion" placeholder="密保问题" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 0 10px","display":"inline-block"}' v-if="userTableName=='yonghu'" label="密保答案" prop="panswer">
