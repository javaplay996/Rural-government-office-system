		...
		<div class="attr" :style='{"padding":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
			...
			<div class="info" :style='{"minHeight":"500px","padding":"20px 0 20px 0","margin":"0px 7% 0px 7%","background":"none","flex":"1","width":"calc(86% - 320px)","order":"1"}'>
				...
				<div class="item" :style='{"padding":"0px","boxShadow":"0 1px 0 #ccc","margin":"0 0 10px 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>资料类型</div>
					<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999"}'>{{detail.ziliaoleixing}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","boxShadow":"0 1px 0 #ccc","margin":"0 0 10px 0","background":"none","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>资料附件</div>
					<el-button :style='{"padding":"0px 10px","margin":"0px","color":"#fff","textAlign":"center","background":"rgb(75, 223, 201)","width":"100px","lineHeight":"40px","fontSize":"14px","textDecoration":"none","height":"40px"}' @click="download(detail.ziliaofujian)">点击下载</el-button>
				</div>
    ...
    methods: {
        init() {
          ...
          this.$http.get(this.tablename + '/detail/'  + this.detail.id, {}).then(res => {
            if (res.data.code == 0) {
              ...
              this.detailBanner = this.detail.ziliaotupian ? this.detail.ziliaotupian.split(",") : [];
              this.$forceUpdate();
            }
          });
      ...
      getStoreupStatus(){
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'changyongziliao', userid: localStorage.getItem('userid')}}).then(res => {
